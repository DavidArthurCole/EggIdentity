...
internal static class Tooltips {
    internal static readonly ImmutableDictionary<string, string> Applies = new Dictionary<string, string> {
        ...
        { ".tooltip-floating::before", "content-[''] absolute top-full left-[calc(50%_+_var(--arrow-offset,_0px))] [transform:translateX(-50%)] border-[7px] border-transparent [border-top-color:#ccc]" },
